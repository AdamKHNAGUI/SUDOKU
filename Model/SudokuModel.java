...
public class SudokuModel {
    ...
    public static final List<int[]> initCoords = new ArrayList<>();
    public static int[] coords = new int[]{0,0,0};
    public static boolean showLastCell = false;
            ...
            for (int j = 0; j < SUBGRID_SIZE; j++) {
                ...
                for (int k = 0; k < SIZE; k++) {
                    ...
                    if (num != 0) {
                        ...
                        return false; // Cellule vide trouvée
                    }
                }
            }
        }
